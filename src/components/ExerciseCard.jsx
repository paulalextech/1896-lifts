	...
	return (
		<div className="p-4 rounded-md flex flex-col gap-4 bg-orange-500 sm:flex-wrap">
			...
			<div className="flex flex-col">
				<h3 className="text-sm capitalize">Muscle Groups</h3>
				<p className="capitalize">{exercise.muscles.join(' & ')}</p>
			</div>

			<div className="flex flex-col bg-orange-500 rounded gap-2">
			...
			<div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
				{['reps', 'rest', 'tempo'].map((info) => {
					return (
						<div
							key={info}
							className="flex flex-col p-2 rounded border-[1.5px] border-solid w-full"
						>
				...
				>
					<h3 className="text-sm capitalize">Sets Completed</h3>
